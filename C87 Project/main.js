...
ctx.lineWidth = 1;
ctx.rect(x, y, width = 430, height = 200);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(x = 250, y = 210, r = 40, startAngle = 0, endAngle = 2 * Math.PI endAngle);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(x = 350, y = 210, r = 40, startAngle = 0, endAngle = 2 * Math.PI endAngle);
ctx.stroke();
// Similarly, create a red circle with position 210 and 40
ctx.beginPath();
ctx.strokeStyle = "red";
ctx.lineWidth = 5;
ctx.arc(x = 210, y = 40, r = 40, startAngle = 0, endAngle = 2 * Math.PI endAngle);
ctx.stroke();
// Similarly, create an orange circle with position 300 and 250
ctx.beginPath();
ctx.strokeStyle = "orange";
ctx.lineWidth = 5;
ctx.arc(x = 300, y = 250, r = 40, startAngle = 0, endAngle = 2 * Math.PI endAngle);
ctx.stroke();
// Similarly, create a green circle with position 400 and 250
ctx.beginPath();
ctx.strokeStyle = "green";
ctx.lineWidth = 5;
ctx.arc(x = 400, y = 250, r = 40, startAngle = 0, endAngle = 2 * Math.PI endAngle);
ctx.stroke();